...
- `GET /api/ledger/organization` reports retained business identity and quote-issue readiness. Owner-only `PUT /api/ledger/organization` updates legal, contact, registration, VAT, address, banking, and default commercial terms.
