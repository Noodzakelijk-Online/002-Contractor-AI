...
- `GET /api/operations/export` downloads a SHA-256 protected v2 reconciliation artifact, including supplier invoices and retained supplier-payment evidence. It is human-readable and explicitly non-restorable.
