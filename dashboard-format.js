...
const STATUS_NL = Object.freeze({
  ...
  approved_waiting: 'goedgekeurd, wacht op start',
  archived: 'gearchiveerd',
  assigned: 'toegewezen',
  available: 'beschikbaar',
  awaiting_acknowledgment: 'wacht op ontvangstbevestiging',
  blocked: 'geblokkeerd',
  busy: 'bezet',
  ...
  draft: 'concept',
  due: 'verschuldigd',
  electrical_isolation: 'elektrische vrijschakeling',
  excavation: 'graafwerk',
  expired: 'verlopen',
  expiring: 'verloopt binnenkort',
  expected: 'verwacht',
  failed: 'mislukt',
  general_work: 'algemene werkzaamheden',
  hot_work: 'heetwerk',
  confined_space: 'besloten ruimte',
  ...
  revise_resubmit: 'herzien en opnieuw indienen',
  scheduled: 'ingepland',
  stable: 'stabiel',
  stored: 'opgeslagen',
  submitted: 'ingediend',
  ...
  void: 'vervallen',
  work_at_height: 'werken op hoogte',
})
