...
| 076 | Technical debt register | Implemented | technical audit records module size, remaining specialist-workspace i18n, autosave and provider-bound load acceptance debt; the practical-core qualification, bid decision and site-survey controls are now bilingual |
