...
| 057 | Internationalization and Dutch/English readiness | Partial | persisted per-operator NL/EN preference, locale-aware formatting, complete token-scoped client portal, and bilingual Performance Scorecard, Framework Register, market-fit, bid/no-bid, site-survey, crew-capacity/two-week planning, Last Planner, 5S, LMRA, and 13-week cash-flow controls; remaining specialist workspaces still contain English-only copy |
