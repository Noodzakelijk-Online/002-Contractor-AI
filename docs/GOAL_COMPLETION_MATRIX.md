...
| 019 | Audit logging and event history | Implemented | transaction-bound SHA-256 chain, server-bound local/authenticated/portal actors, history UI, integrity/readiness checks |
