...
| 076 | Technical debt register | Implemented | technical audit records module size, remaining specialist/parent-workspace i18n, autosave and provider-bound load acceptance debt; qualification, bid decision, site survey, crew planning, quality, closeout, client-success and cash-flow practical-core controls are now bilingual |
